  ...
  private shows = signal<Show[]>([
    {
      ...
      imagemCapaUrl: 'assets/images/shows/bts.webp',
      dataFilaPreferencial: new Date('2026-06-10'),
      dataFilaNormal: new Date('2026-06-11'),
      fasClubeId: '1',
    ...
    },
    {
      ...
      imagemCapaUrl: 'assets/images/shows/twice.webp',
      dataFilaPreferencial: new Date('2026-07-01'),
      dataFilaNormal: new Date('2026-07-02'),
      fasClubeId: '2',
    ...
    },
    {
      ...
      imagemCapaUrl: 'assets/images/shows/iron-maiden.jpg',
    ...
    },
    {
      ...
      imagemCapaUrl: 'assets/images/shows/coldplay.jpg',
      dataFilaPreferencial: new Date('2026-06-05'),
      dataFilaNormal: new Date('2026-07-10'),
      fasClubeId: '4',
    ...
    },
    {
      ...
      imagemCapaUrl: 'assets/images/shows/falcao.webp',
    ...
    },
    {
      ...
      imagemCapaUrl: 'assets/images/shows/taylor-swift.jpg',
      dataFilaPreferencial: new Date('2026-09-01'),
      dataFilaNormal: new Date('2026-09-02'),
      fasClubeId: '6',
